    ...
    <>
      ...
      <main>
        ...
        <section className="button-container-bottom">
          <Link to="/week4Theory" onClick={() => window.scrollTo({ top: 0 })}>
            <button className="button button-left-bottom">
              Previous
            </button>
          </Link>
          <Link to="/week5Theory" onClick={() => window.scrollTo({ top: 0 })}>
