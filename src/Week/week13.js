...
function WeekThree() {
  return (
    <div>
      <h1>Thought bubbles and memes!</h1>
      <p className="date">Posted on May 10, 2023</p>
      <main>
        <section className="blog-content">
          <img src="https://www.bingeclock.com/memes/family-guy___whats_going_on_in_thought_bubble.jpg" alt="Photo of thought bubble and a meme" />
