...
<section className = "design-container ">
  ...
  <section className = "card-wrapper swiper-wrapper">
    ...
    <section className="swiper-slide"><img src={homeWire} alt="an image showing wireframe of homepage"/></section>
    <section className="swiper-slide"><img src={IntroTo} alt="an image showing wireframe of intro to internet"/></section>
    <section className="swiper-slide"><img src= {blogsWire} alt="an image showing wireframe of blog page"/></section>
    <section className="swiper-slide"><img src={memeswire} alt="an image showing wireframe of internet art"/></section>
    <section className="swiper-slide"><img src={screen226} alt="an image showing wireframe of design page"/></section>
    <section className="swiper-slide"><img src={screen227} alt="an image showing wireframe of blog page"/></section>
    <section className="swiper-slide"><img src={screen228} alt="an image showing wireframe of blog page"/></section>
  ...
  <section className="swiper-pagination"></section>
  </section>
</section>
